...
Public Sub Initialize(b As BANanoObject) As JSLocalStorage
	bo = b
	Return Me
End Sub
...
'setItem
Sub setItem(k As String, v As Object) As JSLocalStorage
	bo.RunMethod("setItem", Array(k, v))
	Return Me
End Sub

'removeItem
Sub removeItem(k As String) As JSLocalStorage
	bo.RunMethod("removeItem", Array(k))
	Return Me
End Sub

'clear
Sub clear As JSLocalStorage
